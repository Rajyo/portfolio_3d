...
const About = () => {
  ...
  return (
    <div id="about" style={{ background: bg,}}>
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 -mt-1 pt-14 pb-12">
        <h2
          className={
            darkMode
          ...
          <motion.div className="flex flex-wrap mt-8 justify-between">
            {techStack.map((el, index) => (
              <motion.div
                ...
                className="py-2 px-1 md:py-2 md:px-4 bg-gray-50 md:m-4 md:mx-2 mt-6 rounded-lg flex items-center hover:scale-125 cursor-pointer w-32 sm:w-40 md:w-48"
              >
